...
function buildBasePrompt() {
  return [
    ...
    "If there is a useful variable object, add one or two native GeoGebra sliders even when the user did not explicitly ask for animation.",
    ...
    "For dynamicControls descriptions, use teacher-facing labels such as '动点 P 的位置', '直线斜率', '区间左端点', or '截面高度', not abstract labels like 'parameter t'.",
